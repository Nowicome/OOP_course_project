...
class YandexDisk:
    ...
    def upload_file_to_disk(self, disk_file_path, path_to_our_file):
        """
        disk_file_path - path there will be saved file, and it consists name that we give it with save on YaDisk
        path_to_our_file - web link or path to our file in system
        """
