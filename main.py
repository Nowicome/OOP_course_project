...
def save_photos(vk_id, y_token, count=5):
    ...
    print(url)
    token = input("Перейдите по ссылке выше и введите полученный токен")
...
if __name__ == "__main__":
    my_id = input("Введите id пользователя vk")
    my_token = input("Введите токен с Полигона Яндекс.Диска")
